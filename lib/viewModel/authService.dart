...
// 2. Update the saveUserToFirestore method
  Future<void> saveUserToFirestore(Map<String, String> userData) async {
    ...
    await docRef.set({
      'name': autoGeneratedName,  // Use auto-generated name instead of userData['name']
      'email': email,
  ...
  Future<bool> handleEmailVerificationComplete() async {
    try {
      ...
      // Write user data to Firestore before clearing
