...
//           if (vehicleNumberControllers[i].text.trim().isNotEmpty) {
//             Map<String, dynamic> vehicleMap = {
//               'type': vehicles[i].type.toString(),
//               'number': vehicleNumberControllers[i].text.trim(),
//             };
//
//             // Add dimensions for cars
//             if (vehicles[i].type == VehicleType.car) {
//               vehicleMap['width'] = double.tryParse(vehicleWidthControllers[i].text) ?? 0.0;
//               vehicleMap['height'] = double.tryParse(vehicleHeightControllers[i].text) ?? 0.0;
//             }
//
...
//           'vehicle': jsonEncode(vehicleData),
...
//                 _buildAnimatedTextField(
//                   controller: vehicleNumberControllers[index],
//                   hintText: 'Vehicle Number',
//                   icon: Icons.confirmation_number_outlined,
//                   focusNode: vehicleNumberFocusNodes[index],
//                   validator: (value) =>
...
//
//                 // Car-specific fields
//                 if (vehicles[index].type == VehicleType.car) ...[
//                   const SizedBox(height: 15),
//                   Row(
//                     children: [
//                       Expanded(
//                         child: _buildAnimatedTextField(
//                           controller: vehicleWidthControllers[index],
//                           hintText: 'Width (meters)',
//                           icon: Icons.straighten,
//                           focusNode: vehicleWidthFocusNodes[index],
//                           validator: (value) {
//                             if (value == null || value.isEmpty) {
...
//                       Expanded(
//                         child: _buildAnimatedTextField(
//                           controller: vehicleHeightControllers[index],
//                           hintText: 'Height (meters)',
//                           icon: Icons.height,
//                           focusNode: vehicleHeightFocusNodes[index],
//                           validator: (value) {
//                             if (value == null || value.isEmpty) {
...
//     required IconData icon,
//   }) {
//     final bool isSelected = vehicles[index].type == type;
//
//     return GestureDetector(
//       onTap: () => _selectVehicleType(index, type),
...
//             Icon(
//               icon,
//               color: isSelected ? Colors.orange : _currentTheme.textTheme.bodyMedium!.color,
//               size: 20,
//             ),
...
//               label,
//               style: TextStyle(
//                 color: isSelected ? Colors.orange : _currentTheme.textTheme.bodyLarge!.color,
...
//   }
//
//   void _selectVehicleType(int index, VehicleType type) {
//     setState(() {
//       vehicles[index].type = type;
//       if (type == VehicleType.bike) {
//         vehicles[index].width = null;
//         vehicles[index].height = null;
//         vehicleWidthControllers[index].clear();
//         vehicleHeightControllers[index].clear();
//       }
//     });
//   }
//
//   void _addVehicle() {
//     setState(() {
//       vehicles.add(VehicleInfo(type: VehicleType.car, number: ''));
//       vehicleNumberControllers.add(TextEditingController());
//       vehicleWidthControllers.add(TextEditingController());
//       vehicleHeightControllers.add(TextEditingController());
//       vehicleNumberFocusNodes.add(FocusNode());
//       vehicleWidthFocusNodes.add(FocusNode());
//       vehicleHeightFocusNodes.add(FocusNode());
//     });
//   }
//
//   void _removeVehicle(int index) {
//     setState(() {
//       vehicleNumberControllers[index].dispose();
//       vehicleWidthControllers[index].dispose();
//       vehicleHeightControllers[index].dispose();
//       vehicleNumberFocusNodes[index].dispose();
//       vehicleWidthFocusNodes[index].dispose();
//       vehicleHeightFocusNodes[index].dispose();
//
//       vehicles.removeAt(index);
//       vehicleNumberControllers.removeAt(index);
//       vehicleWidthControllers.removeAt(index);
//       vehicleHeightControllers.removeAt(index);
//       vehicleNumberFocusNodes.removeAt(index);
//       vehicleWidthFocusNodes.removeAt(index);
//       vehicleHeightFocusNodes.removeAt(index);
//     });
//   }
//
//
...
//   double? height;
//
//   VehicleInfo({required this.type, required this.number, this.width, this.height});
// }
//
// final List<VehicleInfo> vehicles = [VehicleInfo(type: VehicleType.car, number: '')];
// final List<TextEditingController> vehicleNumberControllers = [TextEditingController()];
// final List<TextEditingController> vehicleWidthControllers = [TextEditingController()];
// final List<TextEditingController> vehicleHeightControllers = [TextEditingController()];
// final List<FocusNode> vehicleNumberFocusNodes = [FocusNode()];
// final List<FocusNode> vehicleWidthFocusNodes = [FocusNode()];
// final List<FocusNode> vehicleHeightFocusNodes = [FocusNode()];